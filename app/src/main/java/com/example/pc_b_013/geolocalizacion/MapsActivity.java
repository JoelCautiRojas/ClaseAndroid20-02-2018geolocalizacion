...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(lima).title("Marker in Sydney"));
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        latitud.setText(String.valueOf(miubicacion.getLatitude()));
        longitud.setText(String.valueOf(miubicacion.getLongitude()));
        lat = miubicacion.getLatitude();
        lon = miubicacion.getLongitude();
